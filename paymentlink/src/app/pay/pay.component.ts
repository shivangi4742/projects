  ...
  createQRL(out: any) {
    if (out && out.transactionRef) {
      ...
      this.sdkService.createBillString(this.pay.amount, this.pay.til, this.txnNo,
        new User(null, null, null, null, null, null, null, null, null, this.pay.mccCode, this.pay.merchantCode, null, this.pay.title, null, null, null, null, null, null, null, null))
