...
import { Transaction, UtilsService } from 'benowservices';

import * as io from 'socket.io-client';

@Injectable()
export class SocketService {
  private _till: string;
  private _merchantCode: string;
  private _socket: SocketIOClient.Socket;
  private _initialized: boolean = false;
  private _audioFile: string = '../../assets/shared/audios/paymentreceived.wav';
  private _newPayments: Array<Transaction> = new Array<Transaction>();
  ...
  getNewPayments(): Array<Transaction> {
  ...
  joinMerchantRoom(merchantCode: string, till: string) {
