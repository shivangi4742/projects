...
export class NewcampaignComponent implements OnInit, AfterViewInit {
  ...
  createCampaign() {
    ...
    this.sdkService.savePaymentLinkDetails(new SDK(true, this.askaddress, true, this.mndpan, this.askpan, this.mndname, this.askname, this.askemail,
      ...
      this.campaignTarget ? this.campaignTarget : null, null, null, null, null, this.mobileNumber, this.campaignName, this.user.mccCode, 
      ...
      this.user.merchantCode, this.user.displayName, null, null, null, null, null, selProducts && selProducts.length > 0 ? selProducts : null))
