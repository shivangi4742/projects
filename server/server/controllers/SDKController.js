                                                        ...
                                                        pdfstream.on('close', function () {
                                                            ...
                                                            if (!req.body.dontemailPDF && dData[0].email) {
                                                                ...
                                                                form.append('sendEmailVO', JSON.stringify({
                                                                    "to": dData[0].email, "subject": "Thank you for your donation!", "text": "Dear '"+ dData[0].name +"',<br> Thank you for your generous donation of '" + amnt + "' towards '" + m2Data.businessName + "' .  Your donation reference number is '"+ req.params.txnid +"' <br>  Please find attached the tax-benefit receipt under Section 80G of the Income Tax Act for your donation. <br> We thank you from the bottom of our heart for your contribution. Your support helps us to continue our mission and makes it possible for our organisation to exist and provide the community a warm place to live in. <br> Thank you again!"
                                                                }));
